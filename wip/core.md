...
- [SECTION 2: CHARACTER CREATION](#section-2-character-creation)
  ...
  - [QUIRKS AND TRAITS (d66)](#quirks-and-traits-d66)
    - [Physical Traits (d66)](#physical-traits-d66)
      - [Trait Details](#trait-details)
    - [Quirks (d66)](#quirks-d66)
      - [Quirk Details](#quirk-details)
...
- [SECTION 3: COMBAT](#section-3-combat)
  - [COMBAT](#combat)
    ...
    - [Morale Break](#morale-break)
    - [Injury Table](#injury-table)
    - [Permanent Injuries](#permanent-injuries)
- [SECTION 4: EQUIPMENT](#section-4-equipment)
  - [INVENTORY](#inventory)
    - [Character Sheet Layout](#character-sheet-layout)
    - [Item Sizes](#item-sizes)
      - [Examples](#examples)
    - [The Pack](#the-pack)
      - [Retrieving an item](#retrieving-an-item)
      - [Reorganizing your pack](#reorganizing-your-pack)
    - [Item Usage](#item-usage)
      - [Repairing and Restocking Items](#repairing-and-restocking-items)
  - [WEAPONS](#weapons)
  - [ARMOUR](#armour)
  - [SHIELDS](#shields)
  - [MAGIC SCROLLS](#magic-scrolls)
    ...
    - [Flow table (d12)](#flow-table-d12)
    - [Facet table (d12)](#facet-table-d12)
    - [Mishap tables](#mishap-tables)
      - [Minor mishap (d6)](#minor-mishap-d6)
      - [Major mishap (d6)](#major-mishap-d6)
    - [Crafting Spell Scrolls](#crafting-spell-scrolls)
      - [Tips](#tips)
...
- [SECTION 6: RUNNING THE GAME](#section-6-running-the-game)
  ...
  - [SESSION ZERO](#session-zero)
    ...
    - [Explain the World](#explain-the-world)
    - [Establish the Safe House](#establish-the-safe-house)
    - [Introduce the Gobfather](#introduce-the-gobfather)
    - [The First Job](#the-first-job)
    - [Starting the First Session](#starting-the-first-session)
  ...
  - [SAMPLE DUNGEON: THE BLEACHED CELLAR](#sample-dungeon-the-bleached-cellar)
    ...
    - [Room 4 - The Antechamber](#room-4---the-antechamber)
    - [Room 5 - The Ritual Chamber](#room-5---the-ritual-chamber)
- [SECTION 7: TRAVEL, DOWNTIME \& THE City](#section-7-travel-downtime--the-city)
  ...
  - [THE SAFE HOUSE](#the-safe-house)
    ...
    - [Upgrades](#upgrades)
    - [If It Gets Compromised](#if-it-gets-compromised)
  - [THE GOBFATHER](#the-gobfather)
    - [Standing](#standing)
    - [Tony Goblioni](#tony-goblioni)
    - [Running the Gobfather](#running-the-gobfather)
    - [Standing in Practice](#standing-in-practice)
    - [Escalation](#escalation)
    - [The Gobfather as a Quest Giver](#the-gobfather-as-a-quest-giver)
  - [JOBS](#jobs)
    - [Rolling a Job (d20)](#rolling-a-job-d20)
  - [CONTACTS](#contacts)
    - [Gaining Contacts](#gaining-contacts)
    - [Using a Contact](#using-a-contact)
    - [Loyalty](#loyalty)
    - [Contacts and the Gobfather](#contacts-and-the-gobfather)
    - [Contact Types (d8)](#contact-types-d8)
  - [CAPTURE](#capture)
    - [The Cell](#the-cell)
    - [Getting Out](#getting-out)
    - [Escape Table (d6)](#escape-table-d6)
  ...
  - [OVERLAND TRAVEL](#overland-travel)
    ...
    - [Camping](#camping)
    - [Regional Encounter Tables](#regional-encounter-tables)
- [SECTION 8: BESTIARY](#section-8-bestiary)
  ...
  - [MAJOR NPC BESTIARY](#major-npc-bestiary)
    - [GLIMMERHOLD](#glimmerhold)
    - [UNDERHOLD](#underhold)
    - [BRIGHTWATCH COMPANY](#brightwatch-company)
    - [THE OPEN COATS](#the-open-coats)
    - [OTHERS](#others)
- [SECTION 9: TABLES](#section-9-tables)
    - [Item Sizes](#item-sizes-1)
      - [Examples](#examples-1)
  - [BASIC LOOT TABLE](#basic-loot-table)
    - [1–40: Scrap and Common](#140-scrap-and-common)
    - [41–70: Monster Parts and Better Gear](#4170-monster-parts-and-better-gear)
    - [71–90: Hero Loot](#7190-hero-loot)
    - [91–100: Rare and Dangerous](#91100-rare-and-dangerous)
  - [MAGIC ITEMS](#magic-items)
    - [Weapons (d66: 11–16)](#weapons-d66-1116)
    - [Armour (d66: 21–26)](#armour-d66-2126)
    - [Boots and Gloves (d66: 31–36)](#boots-and-gloves-d66-3136)
    - [Rings and Amulets (d66: 41–46)](#rings-and-amulets-d66-4146)
    - [Cloaks and Wearables (d66: 51–56)](#cloaks-and-wearables-d66-5156)
    - [Rare and Cursed (d66: 61–66)](#rare-and-cursed-d66-6166)
  - [DUNGEON VALUABLES](#dungeon-valuables)
  - [UNDERHOLD HOARD TABLES](#underhold-hoard-tables)
    - [Generating the Hoard](#generating-the-hoard)
    - [Hoard Weapons (d20)](#hoard-weapons-d20)
    - [Hoard Armour (d10)](#hoard-armour-d10)
    - [Hoard Odds and Ends (d20)](#hoard-odds-and-ends-d20)
  - [GOBLIN NAMES \& ATTRIBUTES](#goblin-names--attributes)
    - [Goblin Names (d66)](#goblin-names-d66-1)
    - [Physical Traits (d66)](#physical-traits-d66-1)
    - [Quirks (d66)](#quirks-d66-1)
...
A goblin must eat **twice per day** or gain the **Hungry** condition.
...
Roll **the Gob Die** after a failed Vital Blow save. You cannot add COURAGE to this roll.
...
| Head | Helmet, hat, goggles, necklaces |
| Body | Armour, cloak, robes |
| Accessory | Quiver, boots, tools |
...
Items are stored on a grid. You may only retrieve **items that do not have items on top of them.** 
...
|---|---|---|---|
| **Improvised and Barehand** | d3+d3 | [1] | Improvised weapons have (2*) |
| **Quick** | d4+d4 | [1] | d4 dice cannot be discarded due to Dodge |
| **Light** | d6+d6 | [1] |  |
| **Medium** | d6+d8 | [1] | Main hand only |
| **Heavy** | d8+d8 | [11] | Two-handed |
| **Reach** | d4+d10 | [11] | Two-handed, d4 dice cannot be discarded due to Dodge |
| | | | |
...
| **Heavy** | 4 | Body [1] | MEAT 8+ | Cannot dodge |
| **Full** | 5 | Body+Head [11] | MEAT 10+ | Cannot dodge |
...
| **Thief's buckler** | (2) | [1] | Has d4+d4 attack dice |
...
**The Underhold is where the shadows reside.** The sprawling network of the Gobfather. A society beneath a society. The goblins can find safety here, as well as most of your general needs that an actual city would provide normal folk... just with more backstabbing, lying and treachery.
...
| Result | Effect |
|---|---|
| **Success** | Clear 1 STRESS for every 10g pulled. Gain a contact. |
| **Failure** | Clear 1 STRESS for every 10g pulled. Roll on the Trouble Table. |
...
| Result | Effect |
|---|---|
| **Success** | Gain d10 x 10 gold, which goes straight into the Hoard. This gold pays down debts. Standing may improve. |
| **Failure** | Gain half that (rounded up) and a complication. The GM introduces a problem. |
...
> If it's a long term scheme you can create a track to mark the progress over time. On a success, mark the track, on a failure there is no progress.
...
| 2 | You accidentally started a rumour about the Gobfather. He heard it. Roll a WITS save and drop one step on the Standing tracker on a failure. |
...
| 6 | You told someone about the dungeon. Not where, just that it exists. The Itch starts at 15 next adventure. |
| 7 | You woke up with a tattoo. It means something to someone. Three NPCs have recognised it so far. |
| 8 | You have a new pet. It's small and it smells. |
...
| **In Debt** | You owe him. You gain 1/2 XP (rounded up) when you add treasures to the Hoard. |
| **Bad Standing** | He's watching you. All contact costs increase and Contact Loyalty cannot improve. |

**Standing drops** when you pull from the Hoard unsanctioned, burn a Contact, fail a job, or embarrass the operation.

**Standing improves** when you bring back exceptional hauls, handle a job cleanly, or do something that makes him look good.
...
**What he wants:** the Hoard to grow, the operation to run smoothly and no attention from the lords or the Watch. Probably in that order too.
...
**What he won't do:** take risks for goblins who have not earned it, explain himself, forgive the same mistake twice or pretend he doesn't know what he knows.
...
5. He stops protecting them. The party is on their own. Folks of The City may shun them.

He does not send someone to hurt them, he simply removes the reasons that folks haven't been hurting them.
...
If the party needs work and the Gobfather isn't offering, roll d20 on the job board.
...
> **The Snitch** may declare a contact exists once in a session, narrating how they know them. The contact is real and functional. Roll on the Contact Type table. The GM decides what they want in return.
...
Each day imprisoned, roll on the Cell table.
...
| 3 | Overpower a guard. MEAT save. On a failure, take d4 damage and lose the opportunity. |
| 4 | Pick the lock. MEAT save. Harder without tools - TN +2 without lockpicks. |
| 5 | Slip out during a distraction. ZEST save - nerve and timing. On a failure, the distraction passes without you. |
...
1. **Pick a direction**
2. **Roll for weather**
3. **Roll WITS to navigate** - one party member may act as navigator to roll. On a failure the party drifts to a hex beside the desired hex that touches the current hex 
...
Tony Goblioni, if present, automatically succeeds at navigation.

### Camping

Camping takes one full Watch and counts as a Long Rest. Roll the encounter die at the end of camp.

A fire is warm and comfortable and may be visible one hex over.
